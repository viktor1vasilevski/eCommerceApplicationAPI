...
public static class UserBasketConstants
{
    ...
    public const string ERROR_REMOVING_ALL_USER_BASKET_ITEMS = "An error occurred while removing all the basket items.";
    ...
    public const string ERROR_EMPTY_BASKET_CHECKOUT = "Your basket is empty. Please add items before proceeding to checkout.";
    ...
    public const string SUCCESS_REMOVE_ALL_BASKET_ITEMS = "Your basket has been cleared. Thank you for shopping with us!";
